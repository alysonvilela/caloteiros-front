...
export function DashboardCard({
  ...
  const distribuitorValue = new Intl.NumberFormat("pt-BR", {
    style: "currency",
    currency: "BRL",
  }).format(0);
  const nonDistribuitorValue = new Intl.NumberFormat("pt-BR", {
    style: "currency",
    currency: "BRL",
  }).format(service.value / 100 / service.team.length);
            ...
            <div className={cn("", className)} {...props}>
              <div className="space-y-3 w-full">
                ...
                <div className="flex justify-between">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {service.is_distribuitor
                      ? distribuitorValue
                      : nonDistribuitorValue}
                  </p>
                </div>
                <Separator className="h-[0.5px]" />
                <div className="flex justify-between">
